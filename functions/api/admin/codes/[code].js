...
export async function onRequestPatch(context) {
  ...
  if (body.student_profile && typeof body.student_profile === 'object') {
    ...
    updated.progress = {
      ...
      current_level: updated.progress?.current_level || 'L1',
      rank_title: updated.progress?.rank_title || 'Đồng',
      rank_asset_url: updated.progress?.rank_asset_url || '/assets/r2l/ranks/rank-l1-bronze.svg',
