...
- Design self-verification: pending — screenshots of every card state at 390 + 1280 on the deployed preview with a real student link, plus proof that a failed gifts call leaves the home intact.
